...
export const themeAwareHeaderPrimaryCtaClasses =
  "!bg-foreground !text-background hover:!opacity-90 ring-1 ring-black/5 dark:ring-white/10 cyberpunk:ring-2 cyberpunk:ring-inset cyberpunk:ring-[var(--sponsor-accent,#2f9e44)] cyberpunk:!bg-[var(--sponsor-accent,#2f9e44)] cyberpunk:!text-black cyberpunk:hover:!bg-black cyberpunk:hover:!text-[var(--sponsor-accent,#2f9e44)] cyberpunk:hover:!opacity-100" as const
