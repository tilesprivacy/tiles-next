...
export const themeAwareHeaderPrimaryCtaClasses =
  "!bg-foreground !text-background hover:!opacity-90 ring-1 ring-black/5 dark:ring-white/10 cyberpunk:!border-2 cyberpunk:!border-[var(--sponsor-yellow,#f7ff61)] cyberpunk:!bg-[var(--sponsor-yellow,#f7ff61)] cyberpunk:!text-black cyberpunk:ring-0 cyberpunk:hover:!bg-black cyberpunk:hover:!text-[var(--sponsor-yellow,#f7ff61)] cyberpunk:hover:!opacity-100" as const
