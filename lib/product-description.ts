...
export const DOWNLOAD_PLATFORM_MACOS_LABEL = "Apple Silicon" as const

export const DOWNLOAD_PLATFORM_LINUX_LABEL = "Linux" as const

/** Linux requirement line under section headings on /download and in download emails. */
export const DOWNLOAD_PLATFORM_LINUX_REQUIREMENT_LABEL =
  "16 GB VRAM recommended" as const
