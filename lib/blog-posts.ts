...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: `<p>We have been working on <a href="https://www.tiles.run/" target="_blank" rel="noopener noreferrer">Tiles</a>. Local-first private AI assistant for everyday use.</p>
