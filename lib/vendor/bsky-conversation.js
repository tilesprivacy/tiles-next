/**
 * bsky-conversation — a web component that renders a Bluesky post's
 * conversation (replies, quote posts, reposts) as embedded comments.
 *
 * Vendored unmodified from https://tangled.org/jimray.bsky.team/bsky-conversation
 * (distributed build: https://jimray-bsky.tngl.io/bsky-conversation/bsky-conversation.js,
 * fetched 2026-08-14). MIT licensed.
 *
 * Self-hosted so blog pages never load third-party runtime scripts; the only
 * network calls are the component's own requests to Bluesky's public AppView.
 * Import client-side only — the component extends HTMLElement.
 */
