          ...
          <table role="presentation" width="560" cellpadding="0" cellspacing="0" class="container" style="width:560px; max-width:560px;">
            ...
            <tr>
              <td style="padding:0 0 18px 0;">
                <p class="body-copy" style="margin:0 0 12px 0; color:#e5e5e5; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif; font-size:16px; line-height:1.68; font-weight:400;">
                  You were sent this email because you requested a download link from the Tiles website.
                </p>
            ...
            <tr>
              <td style="padding:23px 0 12px 0;">
                <p class="body-copy" style="margin:0; color:#e5e5e5; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif; font-size:16px; line-height:1.68; font-weight:400;">
                  Public alpha for macOS and Linux. Minimum recommended system requirements: 16 GB of unified memory on Macs, or 16 GB of VRAM on Linux machines.
                </p>
              </td>
            </tr>
            <tr>
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" class="button download-cta">
                    <tr>
                      <td bgcolor="#f5f5f7" class="download-cta-cell" style="border-radius:10px; background-color:#f5f5f7 !important; border:1px solid rgba(255,255,255,0.1) !important;">
                        <a href="{{{DOWNLOAD_URL}}}" class="download-cta-link" style="display:inline-block; padding:10px 20px; color:#1f1f1f !important; -webkit-text-fill-color:#1f1f1f !important; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif; font-size:14px; line-height:20px; font-weight:500; text-decoration:none; border-radius:10px;">
              ...
              <td style="padding:0 0 24px 0;">
                <div class="download-cta-shell" style="color-scheme:light only; supported-color-schemes:light;">
                  <table role="presentation" cellpadding="0" cellspacing="0" class="button download-cta">
                    <tr>
                      <td bgcolor="#f5f5f7" class="download-cta-cell" style="border-radius:10px; background-color:#f5f5f7 !important; border:1px solid rgba(255,255,255,0.1) !important;">
                        <a href="{{{OFFLINE_DOWNLOAD_URL}}}" class="download-cta-link" style="display:inline-block; padding:10px 20px; color:#1f1f1f !important; -webkit-text-fill-color:#1f1f1f !important; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif; font-size:14px; line-height:20px; font-weight:500; text-decoration:none; border-radius:10px;">
                          <img src="https://tiles.run/icon-apple-111111.svg" width="14" height="14" alt="" aria-hidden="true" style="display:inline-block; width:14px; height:14px; margin-right:8px; vertical-align:-2px;" />
            ...
            <tr>
              <td style="padding:0 0 9px 0;">
                <p class="body-copy" style="margin:0; color:#e5e5e5; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif; font-size:16px; line-height:1.68; font-weight:400;">
                  A supported GPU is used automatically when available. You will be prompted to download the default model during onboarding.
                </p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding:0 0 34px 0;">
                <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 10px 0;">
                  <tr>
                    <td align="center" valign="middle" width="32" height="32" style="width:32px; height:32px; border-radius:8px; background-color:#171717;">
                      <img src="https://tiles.run/icon-manual-d4d4d8.svg" width="20" height="20" alt="" aria-hidden="true" style="display:block; margin:6px auto; width:20px; height:20px;" />
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td style="padding:0 0 34px 0;">
                <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 10px 0;">
                  <tr>
                    <td align="center" valign="middle" width="32" height="32" style="width:32px; height:32px; border-radius:8px; background-color:#171717;">
                      <img src="https://tiles.run/icon-discord-d4d4d8.svg" width="20" height="20" alt="" aria-hidden="true" style="display:block; margin:6px auto; width:20px; height:20px;" />
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td style="padding:0 0 44px 0;">
                <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 10px 0;">
                  <tr>
                    <td align="center" valign="middle" width="32" height="32" style="width:32px; height:32px; border-radius:8px; background-color:#171717;">
                      <img src="https://tiles.run/icon-releases-d4d4d8.svg" width="20" height="20" alt="" aria-hidden="true" style="display:block; margin:6px auto; width:20px; height:20px;" />
                    </td>
                  </tr>
                </table>
