...
You can view this list on [Semble](https://semble.so/profile/tiles.run/collections/3mkplxagc4i2q).

## Motivations

- ✨ [Mitigating Geopolitical Risks with Local-First Software and atproto, Martin Kleppmann](https://www.infoq.com/presentations/cloud-computing-technological-sovereignty-multi-cloud/)
...
- ✨ [On an Atmosphere OS, Scott](https://scott.leaflet.pub/3mry5dbjdg22a)

## Links

### LLMs

- ✨ [Agent Skills | Chainguard](https://www.chainguard.dev/agent-skills)
...
- ✨ [NVIDIA eGPU on macOS: RTX 3090 & 5090 Benchmarks | lucebox](https://www.lucebox.com/blog/egpu-myth)
- ✨ [Equivariance Encryption for Private LLM Inference](https://davide221.github.io/articles/equivariance-encryption.html)
...
- ✨ [Defining Continual Learning](https://x.com/carnot_cyclist/status/2041479655035679163)
...
- ✨ [dstack - Open Source Confidential Computing | Phala](https://phala.com/dstack)
