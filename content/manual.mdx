...
```text
FROM mlx-community/Qwen2.5-1.5B-Instruct-4bit
SYSTEM You are a concise assistant.
```

Use any `mlx-community/` model hosted on Hugging Face in the `FROM` field. Other model hosts and namespaces are not supported there right now.
