...
See the [Agent Plugins authoring guide](https://agent-plugins.org/plugin-authors/build-an-agent-plugin) for the complete portable format. Learn how to use [Skills slash commands](#using-skills) in chat.
