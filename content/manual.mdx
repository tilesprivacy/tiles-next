...
When both devices have internet access, linking and sync can run through Iroh relays. You only need:
...
On the same local network without internet, devices discover each other over mDNS. Linking and sync use listener and initiator roles.
