...
tiles optimize path/to/your.Modelfile

# Optimize with custom training data
tiles optimize my.Modelfile --data training-data.json

# Optimize using a specific model
tiles optimize my.Modelfile --model anthropic:claude-3-5-sonnet-20240620
```
