...
<a
  ...
  className="inline-flex [&>svg]:hidden"
>
  <NextImage
...
Manage the local inference server. [Source](https://github.com/tilesprivacy/tiles/blob/main/tiles/src/daemon/server.rs).
...
Work directly with the Pi agent. Create a session before sending prompts. [Source](https://github.com/tilesprivacy/tiles/blob/main/tiles/src/daemon/agent.rs).
...
Create sessions and work with locally stored chats. [Source](https://github.com/tilesprivacy/tiles/blob/main/tiles/src/daemon/session.rs).
...
Create and inspect the local Tiles account. [Source](https://github.com/tilesprivacy/tiles/blob/main/tiles/src/daemon/account.rs).
...
Connect an ATproto account and publish session snapshots. [Source](https://github.com/tilesprivacy/tiles/blob/main/tiles/src/daemon/atproto.rs).
...
- [Bruno collection and runnable requests](https://github.com/tilesprivacy/tiles/tree/main/docs/apis/tilekit%20apis)
- [Daemon route definitions and handlers](https://github.com/tilesprivacy/tiles/tree/main/tiles/src/daemon)
- [API design overview](https://github.com/tilesprivacy/tiles/blob/main/docs/adr/tilekit.md)
