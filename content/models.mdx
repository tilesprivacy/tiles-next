...
Starting with **Release 21**, Tiles uses Google’s <span className="inline-flex items-center gap-1 align-baseline"><img src="https://ai.google.dev/gemma/images/gemma_sq.png" alt="Gemma logo" className="h-3.5 w-3.5" />[`gemma4-12b`](https://ai.google.dev/gemma/docs)</span> as the default model for everyday tasks. Release 21 also moves Tiles’ local inference backend from [MLX-LM](https://github.com/ml-explore/mlx-lm) to [llama.cpp](https://github.com/ggml-org/llama.cpp), giving supported platforms a common inference stack built around GGUF models.
