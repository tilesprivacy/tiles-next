...
We currently use Google’s <span className="inline-flex items-center gap-1 align-baseline"><img src="https://ai.google.dev/gemma/images/gemma_sq.png" alt="Gemma logo" className="h-3.5 w-3.5" />[`gemma4-12b`](https://ai.google.dev/gemma/docs)</span> model as the primary model for everyday tasks, running locally on the llama.cpp inference stack.
