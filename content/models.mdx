...
For Beta builds, we have selected [gpt-oss-20b](https://openai.com/index/introducing-gpt-oss/) as the primary model for everyday tasks and support the [Open Responses](https://www.openresponses.org/) API for this purpose. This setup requires 16 GB of unified memory to run optimally and should not pose an adoption issue, as all Macs sold from mid-2025 onward ship with 16 GB of base memory.
