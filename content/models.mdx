...
For Beta builds, we have selected [gpt-oss-20b](https://openai.com/index/introducing-gpt-oss/) as the primary model for everyday tasks and support the [Open Responses](https://www.openresponses.org/) API for this purpose. Its Mixture of Experts architecture activates only around 4B parameters at inference time out of a total 21B, making it a strong balance between quality and efficiency.
