---
title: "Overview"
description: "Product overview, comparison details, and the security FAQ for Tiles."
---
...
<div className="not-prose mt-7 grid gap-7 sm:mt-8 sm:gap-10 lg:grid-cols-2 lg:gap-x-16 lg:gap-y-12">
  <div className="space-y-2.5 sm:space-y-3 lg:space-y-4">
    ...
    <div className="text-sm leading-relaxed text-black/60 dark:text-[#B3B3B3] lg:text-base">
      Embedded [Pi](https://pi.dev) agent harness for knowledge work and coding, with extensions for fully customizable
  ...
  <div className="space-y-2.5 sm:space-y-3 lg:space-y-4">
    ...
    <div className="text-sm leading-relaxed text-black/60 dark:text-[#B3B3B3] lg:text-base">
      ...
      [Modelfile](/book/tilekit#modelfile-reference) and [Open Responses API](https://www.openresponses.org).
    </div>
  </div>
