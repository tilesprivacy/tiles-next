...
<div className="not-prose mt-7 grid gap-7 sm:mt-8 sm:gap-10 lg:grid-cols-2 lg:gap-x-16 lg:gap-y-12">
  ...
  <div className="space-y-2.5 sm:space-y-3 lg:space-y-4">
    ...
    <div className="text-sm leading-relaxed text-black/60 dark:text-[#B3B3B3] lg:text-base">
      [Modelfile](/book/tilekit#modelfile-reference) support for building and sharing models, powered by [MLX](https://ml-explore.github.io/mlx/build/html/index.html) on Apple Silicon.
    </div>
  </div>
  ...
  <div className="space-y-2.5 sm:space-y-3 lg:space-y-4">
    ...
    <div className="text-sm leading-relaxed text-black/60 dark:text-[#B3B3B3] lg:text-base">
      Tilekit is an embeddable app-server runtime for identity, memory, sync, and agent templates, built on open standards like
