...
## Tiles CLI
Tiles is a private AI assistant for everyday use. The CLI is the easiest way to start using Tiles. The experience will be familiar to anyone who has worked with e.g. Ollama or LM Studio CLIs. Just download Tiles and get started with the ``tiles run`` command, which runs the recommended default memory model for your device.
