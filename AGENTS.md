...
- When cleaning changelog bullets in `lib/releases.ts`, remove dangling trailing connectors (for example ending in "in", "via", "through", or "under") after issue-reference cleanup so each line remains grammatical.
