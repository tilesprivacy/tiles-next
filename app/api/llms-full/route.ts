...
export async function GET(request: Request) {
  ...
  pushSection(lines, `Homepage (${baseUrl}/)`, [
    ...
    'Feature (coming soon): WebUI: A browser-based interactive chat interface for Tiles. Based on llama-ui (https://github.com/ggml-org/llama.cpp/tree/master/tools/ui).',
