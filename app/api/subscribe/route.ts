                    ...
                    <tr>
                      <td class="email-section-gap" style="padding-bottom: 40px;">
                        ...
                        <p class="email-body" style="color: #666666; font-size: 17px; margin: 0 0 16px 0; line-height: 1.6;">
                          ${TILES_PRODUCT_DESCRIPTION} Born from the <a href="https://userandagents.org" class="email-body-link" style="color: #000000; text-decoration: underline;">User &amp; Agents</a> community, Tiles is built for people who want intelligence without renting their memory to centralized providers.
                        </p>
