...
export async function GET(request: Request) {
  ...
  sections.push('')
  sections.push('Q: Is memory Python execution a hardened sandbox?')
  sections.push('A: No. Restricted execution with path and size limits, not strong OS isolation. Transitional; may change after Pi agent harness work.')
  sections.push('')
