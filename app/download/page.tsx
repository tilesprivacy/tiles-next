...
export default function DownloadPage() {
  return (
    <div className="relative flex min-h-[100dvh] flex-col bg-white">
          ...
          >
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                className="h-3.5 w-3.5 fill-pink-400 transition-all duration-300 group-hover:scale-110 group-hover:fill-pink-300 group-active:scale-110 lg:h-4 lg:w-4"
              >
      ...
      {/* Main Content */}
      <div className="flex flex-1 flex-col justify-center items-start px-6 py-20 lg:py-32 lg:px-12">
        <div className="flex w-full max-w-md flex-col gap-4 text-left lg:max-w-2xl lg:gap-6">
          ...
          <div className="space-y-2 lg:space-y-3">
            ...
            <div className="pt-4 text-xs text-black/50 lg:text-sm">
              A portable installer is in development for air-gapped deployments, prepackaged with offline models.{" "}
              <a
