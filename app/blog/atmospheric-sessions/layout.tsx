...
export const metadata: Metadata = {
  ...
  other: {
    ...
    "article:published_time": "2026-07-17T00:00:00Z",
  },
}

export default function AtmosphericSessionsLayout({ children }: { children: React.ReactNode }) {
  if (!post || !isBlogPostVisible(post)) notFound()

  return <><StandardSiteLinkTags documentSlug="atmospheric-sessions" includePublication={false} />{children}</>
}
