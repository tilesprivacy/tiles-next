        ...
        <main className="flex flex-1 flex-col items-start justify-center gap-6 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-20 px-4 sm:px-6 md:px-8 lg:px-12 pb-20 pt-16 lg:pb-32 lg:pt-20 w-full max-w-3xl mx-auto">
          <div className="w-full space-y-6 sm:space-y-8 text-sm leading-relaxed text-foreground/80 sm:text-base lg:text-lg lg:leading-relaxed">
            <div className="space-y-4">
              <h1 className="text-2xl font-semibold text-foreground sm:text-3xl lg:text-4xl">Terms of Use</h1>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">Acceptance of Terms</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">Privacy-First Design</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">Open Source License</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">No Warranty</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">Limitation of Liability</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">Changes to Terms</h2>
              <p>
