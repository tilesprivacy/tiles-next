    ...
    <div className="relative flex min-h-screen flex-col bg-white lg:h-screen lg:flex-row lg:overflow-hidden">
      ...
      <aside className="hidden lg:flex lg:w-1/2 items-center justify-center bg-[#0E0E0C]">
        <div className="flex flex-col items-center gap-10">
          ...
          <Button
            asChild
            className="group rounded-full bg-white px-6 py-5 text-base font-medium text-black transition-all duration-300 hover:scale-105 hover:bg-white/90 hover:shadow-lg active:scale-95"
          >
