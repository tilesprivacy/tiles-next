        ...
        <main className="flex flex-1 flex-col items-start justify-center gap-6 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-20 px-4 sm:px-6 md:px-8 lg:px-12 pb-20 pt-16 lg:pb-32 lg:pt-20 w-full max-w-3xl mx-auto">
          <div className="w-full space-y-6 sm:space-y-8 text-sm leading-relaxed text-foreground/80 sm:text-base lg:text-lg lg:leading-relaxed">
            <div className="space-y-4">
              <h1 className="text-2xl font-semibold text-foreground sm:text-3xl lg:text-4xl">Privacy Policy</h1>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">Your Data Stays Local</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">No Tracking</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">No Data Collection</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">Open Source Transparency</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">Website Privacy</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-foreground sm:text-xl lg:text-2xl">Your Control</h2>
              <p>
