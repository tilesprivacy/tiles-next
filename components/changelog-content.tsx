      ...
      <main className="flex-1 px-4 pb-16 pt-32 lg:px-8 lg:pt-44">
        <div className="mx-auto max-w-3xl">
          ...
          <section className="mb-10 border-b border-black/5 pb-10 dark:border-white/10 lg:mb-12 lg:pb-12">
            ...
            <ul className={`mb-5 list-disc space-y-2 pl-5 text-base leading-7 ${textColorBody} lg:text-lg lg:leading-8`}>
                ...
                {releases.map((release, index) => (
                  ...
                  >
                    ...
                    <div className="md:hidden">
                      ...
                      <h2 className={`mb-3 text-lg font-semibold tracking-tight ${textColorHeading}`}>
                    ...
                    <div className="hidden md:grid md:grid-cols-[100px_16px_1fr] md:gap-4">
                      ...
                      <div>
                        <div className="mb-2 flex items-center gap-3">
                          <h2 className={`text-xl font-semibold tracking-tight ${textColorHeading}`}>
