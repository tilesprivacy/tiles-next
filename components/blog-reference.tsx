...
export function BlogReference({ id, children }: BlogReferenceProps) {
  ...
  return (
    <>
      ...
      <sup
        ref={supRef}
        className="text-black/40 dark:text-[#8A8A8A] hover:text-black/50 dark:hover:text-[#B3B3B3] lg:hover:text-black/40 lg:dark:hover:text-[#8A8A8A] cursor-pointer lg:cursor-default font-normal text-[0.7em] ml-[0.15em] mr-[0.15em] transition-colors duration-150"
