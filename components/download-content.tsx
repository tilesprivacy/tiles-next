        ...
        {isMobileClient ? (
          <section className="minimal-download-email" aria-labelledby="download-email-heading">
            ...
            <form onSubmit={sendDownloadLink}>
              <label htmlFor="mobile-download-email" className="sr-only">Email address</label>
              <input
              ...
              {emailMessage ? <p role="status" aria-live="polite" className={emailStatus === "error" ? "minimal-download-email-error" : "minimal-download-email-status"}>{emailMessage}</p> : null}
            </form>
          </section>
        ) : null}
