...
const comparisonRows = [
  ...
  { label: "Plugins", tiles: "check", ollama: "check", lmStudio: "check", jan: "check", osaurus: "check" },
  { label: "Sandbox", tiles: "empty", ollama: "empty", lmStudio: "empty", jan: "empty", osaurus: "check" },
  { label: "Remote Link", tiles: "check", ollama: "empty", lmStudio: "check", jan: "empty", osaurus: "check" },
            ...
            <table className="w-full min-w-[42rem] table-fixed border-separate border-spacing-0 text-left sm:min-w-[48rem]">
              ...
              <thead>
                <tr>
                  ...
                  <th className="border-b border-black/10 px-4 py-3 text-sm font-light text-foreground dark:border-white/10">Tiles</th>
                  <th className="border-b border-black/10 px-4 py-3 text-sm font-light text-foreground dark:border-white/10">Ollama</th>
                  <th className="border-b border-black/10 px-4 py-3 text-sm font-light text-foreground dark:border-white/10">LM Studio</th>
                  <th className="border-b border-black/10 px-4 py-3 text-sm font-light text-foreground dark:border-white/10">Jan</th>
                  <th className="border-b border-black/10 px-4 py-3 text-sm font-light text-foreground dark:border-white/10">Osaurus</th>
                </tr>
              </thead>
              <tbody>
                {comparisonRows
