...
export function BlogPostContent({ 
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-background">
      {/* Main Content */}
      <main className="flex flex-1 flex-col items-center px-6 pt-[calc(4rem+env(safe-area-inset-top,0px))] pb-20 sm:px-8 lg:px-10 lg:pt-[calc(6rem+env(safe-area-inset-top,0px))] lg:pb-24 xl:px-12 gap-6 lg:gap-12 overflow-x-clip">
