  ...
  return (
    <>
      ...
      <footer className={`relative z-10 border-t ${borderColor} ${footerBg} px-6 lg:px-12 py-10 lg:py-12`}>
        ...
        <section className={`site-footer-newsletter grid gap-8 border-b pb-10 lg:grid-cols-[minmax(0,1fr)_minmax(330px,420px)] lg:items-end lg:gap-x-12 lg:gap-y-0 lg:pb-12 ${borderColor}`}>
