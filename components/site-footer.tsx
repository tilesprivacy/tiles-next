...
export function SiteFooter() {
  ...
  const textClasses = footerIsDark
    ? "text-white"
    : "text-black"
  ...
  const iconBase = footerIsDark ? "text-white" : "text-black"
  ...
  if (!mounted) {
    return (
      <footer className="relative z-20 shrink-0 h-[14dvh] border-t border-black/5 bg-white px-4 sm:px-6 overflow-hidden">
        <div className="mx-auto flex h-full max-w-7xl flex-col justify-center gap-2 sm:gap-3 lg:gap-4 text-black">
          <div className="flex flex-row items-center justify-between gap-2 sm:gap-4">
            <nav className="flex items-center gap-3 sm:gap-4 md:gap-6 text-xs sm:text-sm flex-shrink-0">
              <Link href="/sub-processors" className="text-black transition-colors hover:text-black/70 whitespace-nowrap">
                Subprocessors
              </Link>
              <Link href="/terms" className="text-black transition-colors hover:text-black/70 whitespace-nowrap">
                Terms
              </Link>
              <Link href="/privacy" className="text-black transition-colors hover:text-black/70 whitespace-nowrap">
                Privacy
              </Link>
              <a
                href="https://tiles.run/book"
                className="text-black transition-colors hover:text-black/70 whitespace-nowrap"
              >
                Book
              </a>
            </nav>
          ...
          <div className="flex flex-row items-center justify-between gap-2 border-t border-black/5 pt-1.5 sm:pt-2 text-[10px] sm:text-xs text-black">
            <p className="whitespace-nowrap">© 2026 Tiles Privacy</p>
            <a
              href="https://status.tiles.run/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1 transition-colors hover:text-black/70 whitespace-nowrap"
            >
              Status
              <svg
  ...
  return (
    <footer className={footerClasses}>
      <div className={`mx-auto flex h-full max-w-7xl flex-col justify-center gap-2 sm:gap-3 lg:gap-4 ${textClasses}`}>
        <div className="flex flex-row items-center justify-between gap-2 sm:gap-4">
          <nav className="flex items-center gap-3 sm:gap-4 md:gap-6 text-xs sm:text-sm flex-shrink-0">
          ...
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 flex-shrink-0 mt-1 sm:mt-1.5">
            ...
            >
              <FaXTwitter className={`h-3.5 w-3.5 sm:h-4 sm:w-4 ${iconBase} transition-colors ${iconHoverClasses.twitter}`} />
            </a>
            <a
              ...
              aria-label="Bluesky"
            >
              <FaBluesky className={`h-3.5 w-3.5 sm:h-4 sm:w-4 ${iconBase} transition-colors ${iconHoverClasses.bluesky}`} />
            </a>
            <a
            ...
            >
              <FaInstagram className={`h-3.5 w-3.5 sm:h-4 sm:w-4 ${iconBase} transition-colors ${iconHoverClasses.instagram}`} />
            </a>
            <a
              ...
              aria-label="Discord"
            >
              <FaDiscord className={`h-3.5 w-3.5 sm:h-4 sm:w-4 ${iconBase} transition-colors ${iconHoverClasses.discord}`} />
            </a>
            <a
              ...
              aria-label="GitHub"
            >
              <FaGithub className={`h-3.5 w-3.5 sm:h-4 sm:w-4 ${iconBase} transition-colors ${iconHoverClasses.github}`} />
            </a>
            <a
            ...
            >
              <SiHuggingface className={`h-3.5 w-3.5 sm:h-4 sm:w-4 ${iconBase} transition-colors ${iconHoverClasses.huggingface}`} />
            </a>
            <a
              href="/api/rss"
              target="_blank"
              ...
              aria-label="RSS Feed"
            >
              <FaRss className={`h-3.5 w-3.5 sm:h-4 sm:w-4 ${iconBase} transition-colors ${iconHoverClasses.rss}`} />
            </a>
          </div>
        </div>
