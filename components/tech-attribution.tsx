...
function TechLogo({
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" aria-label={label} className={`${techLogoClass} ${className}`}>
...
export function TechAttribution({
  ...
  return (
    ...
    >
      ...
      <TechLogo href="https://www.rust-lang.org" src="/icon-rust.svg" label="Rust" width={144} height={144} variant={variant} />
      ...
      <a
        ...
        rel="noopener noreferrer"
        aria-label="ATProto"
        className="font-mono text-[1em] font-medium text-current transition-opacity hover:opacity-70"
      >
        at://
      </a>
      <span>, and</span>
