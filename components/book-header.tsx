      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 text-base font-medium text-foreground lg:text-lg">
          <Link href="/" className="transition-colors hover:text-foreground/70">
            <Image src={logoSrc} alt="Tiles" width={32} height={32} className="h-7 w-7 lg:h-8 lg:w-8" />
          </Link>
        ...
        >
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              className="h-3.5 w-3.5 fill-background transition-all duration-300 group-hover:scale-110 group-hover:fill-background/70 group-active:scale-110 lg:h-4 lg:w-4"
            >
