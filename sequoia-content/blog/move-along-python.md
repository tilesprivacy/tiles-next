...
tags:
  ...
  - packaging
draft: false
atUri: "at://did:plc:mqmcsjuerbjhu65mpmvkcuw2/site.standard.document/3mnl4nkzyvj2b"
---
...
In earlier releases of Tiles, before 0.4.0, we packed the server files into the final release tarball. During installation, we extracted them to the user's system, downloaded `uv`, installed Python 3.13 if it was not already present, and then ran the server as a daemon.
...
- **Runtimes** define the exact Python runtime version we need.
- **Frameworks** specify shared Python frameworks such as NumPy, MLX, and others.
- **Applications** define the actual server application and its specific dependencies.
